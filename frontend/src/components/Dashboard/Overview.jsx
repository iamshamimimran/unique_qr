...
import { QrCode, Crown, Zap, TrendingUp, ArrowRight } from 'lucide-react';
                ...
                <div className="lg:col-span-2">
                    <Card className="h-full bg-white/5 border-white/5 p-8">
                        <div className="relative z-10">
                            ...
                            <p className="text-gray-400 mb-8 font-medium">Your generation trends over the last 30 days.</p>
                            
                            <div className="h-64 flex items-end justify-between gap-2 px-4 border-b border-white/5 pb-4">
                                {[40, 70, 45, 90, 65, 80, 50, 60, 85, 40, 60, 75].map((h, i) => (
                                    <motion.div 
                                        ...
                                        className="flex-1 bg-gradient-to-t from-indigo-600/20 to-indigo-500/50 rounded-t-lg hover:from-indigo-500 hover:to-indigo-400 transition-all group relative cursor-pointer"
                                    >
                                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-slate-900 text-white text-[10px] font-bold px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-white/10">
                                            {Math.floor(h/2)} QRs
                                        </div>
                                    </motion.div>
                                ))}
                    ...
                    <Card className="bg-gradient-to-br from-indigo-600 to-purple-700 border-none p-8 text-white relative overflow-hidden h-full">
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            ...
                            <Button 
                                ...
                                className="w-full py-4 text-indigo-600 font-bold shadow-xl shadow-black/20 hover:bg-gray-50 border-none"
                            >
                                Upgrade Now
                            </Button>
                        </div>
